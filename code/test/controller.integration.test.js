...
describe("createCategory", () => { 
    ...
    test("Returns the correctly inserted category", (done) => {
        categories.create({
            type:"food",
            color:"green"
        }).then(() => {
...
describe("updateCategory", () => { 
    ...
    test("Returns correctly updated category - only color changes (no transaction changed) ", (done) => {
    ...
    test("Returns correctly updated category - both changes (transaction changed) ", (done) => {
        transactions.insertMany([
            {
                username:"tester",
                amount:100,
...
describe("deleteCategory", () => { 
    ...
    test("Returns correctly deleted message - T (# categories to delete) = N (# databases categories)", (done) => {
        transactions.insertMany([
            {
                username:"tester",
                amount:100,
...
describe("getCategories", () => { 
    ...
    test("Returns both the transactions present", (done) => {
        categories.insertMany([{
            type:"food",
            color:"green"
        },{
    ...
    test("Returns [] because there are no transactions present", (done) => {
        User.create({
            username: "admin",
            email: "admin@email.com",
            password: "admin",
...
describe("createTransaction", () => { 
    ...
    test("Returns the correct transaction", (done) => {
        //We create a category in our empty database (we know it's empty thanks to the beforeEach above)
        categories.create({
            type: "food",
            color: "red"
...
describe("getAllTransactions", () => { 
    ...
    test("Returns all the transactions present", (done) => {
        categories.insertMany([{
            type: "food",
            color: "red"
        },{
    ...
    test("Returns empty list because there are no transactions present", (done) => {
        categories.insertMany([{
            type: "food",
            color: "red"
        },{
...
describe("getTransactionsByUser", () => { 
    ...
    test("Returns all the transaction of the user 'tester' - admin access", (done) => {
        User.insertMany([
            {
                username: "tester",
                email: "tester@test.com",
    ...
    test("Returns [] because the user 'tester' has no transactions - admin access", (done) => {
        User.insertMany([
            {
                username: "tester",
                email: "tester@test.com",
    ...
    test("Returns all the transaction of the user 'tester' - user access", (done) => {
        User.insertMany([
            {
                username: "tester",
                email: "tester@test.com",
    ...
    test("Returns all the transaction of the user 'tester' with amount => 50 - user access", (done) => {
        User.insertMany([
            {
                username: "tester",
                email: "tester@test.com",
    ...
    test("Returns all the transaction of the user 'tester' with 40 <= amount <= 100 - user access", (done) => {
        User.insertMany([
            {
                username: "tester",
                email: "tester@test.com",
    ...
    test("400 Gets an error when passing a non-number min or max", (done) => {
        User.insertMany([
            {
                username: "tester",
                email: "tester@test.com",
    ...
    test("Returns all the transaction of the user 'tester' with date >= 2023-05-20  - user access", (done) => {
        User.insertMany([
            {
                username: "tester",
                email: "tester@test.com",
    ...
    test("Returns all the transaction of the user 'tester' with date <= 2023-04-19 - user access", (done) => {
        User.insertMany([
            {
                username: "tester",
                email: "tester@test.com",
    ...
    test("Returns all the transaction of the user 'tester' with 2023-04-19 <= date <= 2023-05-19 - user access", (done) => {
        User.insertMany([
            {
                username: "tester",
                email: "tester@test.com",
    ...
    test("400 Gets an error when using both date and upTo/from", (done) => {
        User.insertMany([
            {
                username: "tester",
                email: "tester@test.com",
    ...
    test("400 Gets an error when passing an invalid date format", (done) => {
        User.insertMany([
            {
                username: "tester",
                email: "tester@test.com",
    ...
    test("Returns [] because the user 'tester' has no transactions - user access", (done) => {
        User.insertMany([
            {
                username: "tester",
                email: "tester@test.com",
...
describe("getTransactionsByUserByCategory", () => { 
    ...
    test("Returns all transactions of user 'tester' with category 'food'", (done) => {
        User.insertMany([
            {
                username: "tester",
                email: "tester@test.com",
    ...
    test("Returns [] because the user 'tester' has no transactions with category 'food'", (done) => {
        User.insertMany([
            {
                username: "tester",
                email: "tester@test.com",
...
describe("getTransactionsByGroup", () => { 
    ...
    test("Returns all transactions of group 'testgroup'", (done) => {
        Group.insertMany([
            {
                name:"testgroup",
                members:[
    ...
    test("Returns [] because the users in group 'testgroup' have no transactions", (done) => {
        Group.insertMany([
            {
                name:"testgroup",
                members:[
...
describe("getTransactionsByGroupByCategory", () => { 
    ...
    test("Returns all transactions of group 'testgroup' with category 'papers", (done) => {
        Group.insertMany([
            {
                name:"testgroup",
                members:[
    ...
    test("Returns [] because the users in group 'testgroup' have no transactions with category 'food'", (done) => {
        Group.insertMany([
            {
                name:"testgroup",
                members:[
    ...
    test("Returns [] because the users in group 'testgroup' have no transactions at all", (done) => {
        Group.insertMany([
            {
                name:"testgroup",
                members:[
...
describe("deleteTransaction", () => { 
    ...
    test("Succesfully deleted a transaction", (done) => {
        transactions.create({
            username:"tester",
            amount:100,
            type:"food",
