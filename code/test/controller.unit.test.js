...
describe("getCategories", () => { 
    ...
    test('200- should retrieve list of all categories', async () => {
    ...
    test('200- should retrieve empty list (no categories)', async () => {
        verifyAuth.mockReturnValue({authorized:true});
        const mockReq = {};
        const mockRes = {
            status: jest.fn().mockReturnThis(),
...
describe("createTransaction", () => {
    ...
    test('Transaction correctly inserted', async () => {
        //mock auth
        verifyAuth.mockReturnValue({authorized:true, cause:"Authorized"});
        //mock mongoose schemas
        jest.spyOn(User, "findOne").mockImplementation((par) => {return {username:par}});
...
describe("getAllTransactions", () => { 
    ...
    test('Should find multiple transactions', async () => {
        //auth mocking
        verifyAuth.mockReturnValue({authorized:true, cause:"Authorized"});
    ...
    test('Should find empty list if no transactions are present', async () => {
        //auth mocking
        verifyAuth.mockReturnValue({authorized:true, cause:"Authorized"});
...
describe("getTransactionsByUser", () => { 
    ...
    test('Should find multiple transactions for testuser', async () => {
        //auth mocking
        verifyAuth.mockReturnValue({authorized:true, cause:"Authorized"});
    ...
    test('Should return empty array because user has no transactions', async () => {
        //auth mocking
        verifyAuth.mockReturnValue({authorized:true, cause:"Authorized"});
        const retrievedTransactions = [];
...
describe("getTransactionsByUserByCategory", () => { 
    ...
    test('Should return empty array because user has no transactions/no transaction with such category', async () => {
        //auth mocking
        verifyAuth.mockReturnValue({authorized:true, cause:"Authorized"});
        const retrievedTransactions = [];
...
describe("getTransactionsByGroup", () => {
    ...
    test('Should find a transactions for each user in group', async () => {
    ...
    test('Should find a transactions for each user in group, but a user has no transactions', async () => {
        const user1 = {username:"testuser1",email:"u1@mail.com"};
        const user2 = {username:"testuser2",email:"u2@mail.com"};
    ...
    test('Should return an empty array, because no user has any transactions', async () => {
        const user1 = {username:"testuser1",email:"u1@mail.com"};
        const user2 = {username:"testuser2",email:"u2@mail.com"};
...
describe("getTransactionsByGroupByCategory", () => { 
    ...
    test('Should find a single transactions for each user in group even thought some has more than one', async () => {
        const user1 = {username:"testuser1",email:"u1@mail.com"};
        const user2 = {username:"testuser2",email:"u2@mail.com"};
    ...
    test('Should find a transactions for each user in group, except for one who has no trans of that cat', async () => {
        const user1 = {username:"testuser1",email:"u1@mail.com"};
        const user2 = {username:"testuser2",email:"u2@mail.com"};
        const user3 = {username:"testuser3",email:"u3@mail.com"};
    ...
    test('Should return an empty array, because no user has any transaction of that category', async () => {
        const user1 = {username:"testuser1",email:"u1@mail.com"};
        const user2 = {username:"testuser2",email:"u2@mail.com"};
        const user3 = {username:"testuser3",email:"u3@mail.com"};
...
describe("deleteTransaction", () => { 
    ...
    test('Transaction succesfully deleted', async () => {
        //mock auth
        verifyAuth.mockReturnValue({authorized:true, cause:"Authorized"});
        //mock mongoose schemas
        jest.spyOn(User, "findOne").mockImplementation((par) => {return   {username:"testuser"}});
...
describe("deleteTransactions", () => { 
    ...
    test('Transactions succesfully deleted', async () => {
        //mock auth
        verifyAuth.mockReturnValue({authorized:true, cause:"Authorized"});
        //mock mongoose schemas
