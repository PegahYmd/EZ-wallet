...
describe('register', () => {
   ...
   beforeEach(() => {
    ...
    test("Username not defined :error 400",async () => {
    ...
    //no email null
    test("email not defined :error 400",async () => {
    ...
    //no password null 
    test("password not defined :error 400",async () => {
    ...
    test("username empty string :error 400",async () => {
    ...
    //email empty string
    test("email empty string :error 400",async () => {
        mockReq.body.email = "  ";
        jest.spyOn(User, 'findOne').mockResolvedValueOnce(null);
        await register(mockReq,mockRes);
        expect(mockRes.status).toHaveBeenCalledWith(400);
    ...
    test("password empty string  :error 400",async () => {
    ...
    test("email invalid format : error 400",async() => {
    ...
    test("Username taken Error:400", async()=>
    {
    ...
    test("email already used by another person Error :400", async()=>
    {
...
describe("registerAdmin", () => { 
   ...
   beforeEach(() => {
    ...
    //success case test 200
    test('should successfully register the admin', async () => {
...
describe('login', () => {
    ...
    test('should return error if email or password is empty string', async () => {
      req.body.email = '  ';
      req.body.password = '  ';
    ...
    test('should return error if email is in an invalid format', async () => {
...
describe('logout', () => {
    ...
    test('No refresh token: Error 400',async ()=>{
