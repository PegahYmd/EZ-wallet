...
describe("getUsers", () => {
  ...
  test("should return error 401 if user is not admin", (done) => {
    request(app)
      .get("/api/users")
...
describe("getUser", () => {
  ...
  test("should return error 400 if there are no users", (done) => {
    request(app)
  ...
  test("Should retrieve user as an admin",(done) =>{
    User.create({
      username: "tester",
      email : "test@test.com",
      password: "tester",
  ...
  test("Should retrieve itself",(done) =>{
    User.create({
      username: "tester",
      email : "test@test.com",
      password: "tester",
  ...
  test("Should retrieve ONLY itself as User" ,(done) =>{
...
describe("createGroup", () => { 
  ...
  test("Returns 400 because an email is not well formatted", (done) => {
    Group.create({
      name: "test",
      members: [{email:"test1@email.com"},{email:"test2@email.com"}]
    }).then(() => {
  ...
  test("Group created correctly", (done) => {
    Group.create({
      name: "test",
      members: [{email: "test1@email.com"},{email: "test2@email.com"}]
    }).then(() => {
      User.insertMany([
        ...
        .then((response) => {
            ...
            expect(response.body.data.EmailsAlreadyUsed).toHaveLength(0)
            expect(response.body.data.EmailsNotExisting).toHaveLength(0)
            done()
        })
        .catch((err) => done(err))
       })
  ...
  test("Group created correctly with emails not eixsting", (done) => {
    Group.create({
      name: "test",
      members: [{email: "test1@email.com"},{email: "test2@email.com"}]
    }).then(() => {
      User.insertMany([
        ...
        .then((response) => {
            ...
            expect(response.body.data.group).toStrictEqual({name: "testCreate", members:[{email:"test3@email.com"},{email:"admin@email.com"}]})
            expect(response.body.data.EmailsAlreadyUsed).toHaveLength(0)
            expect(response.body.data.EmailsNotExisting).toHaveLength(1)
            done()
        })
        .catch((err) => done(err))
       })
    ...
    Group.create({
      ...
      User.insertMany([
        ...
        .then((response) => {
            expect(response.status).toBe(200)
            expect(response.body.data.group).toStrictEqual({name: "testCreate", members:[{email:"test3@email.com"},{email:"admin@email.com"}]})
            expect(response.body.data.EmailsAlreadyUsed).toHaveLength(1)
            expect(response.body.data.EmailsNotExisting).toHaveLength(0)
            done()
        })
        .catch((err) => done(err))
...
describe("getGroups", () => {   
  ...
  test("Returns all the groups", (done) => {
    Group.insertMany([{
      name: "test1",
      members: [{email: "test1@email.com"},{email: "test2@email.com"}]
    },{
  ...
  test("Returns all the groups, but it's an empty array ", (done) => {
      User.create({
        username: "admin",
        email: "admin@email.com",
        password: "admin",
...
describe("getGroup", () => { 
  ...
  test("Returns the group- admin call", (done) => {
    Group.create({
      name: "test1",
      members: [{email: "test1@email.com"},{email: "test2@email.com"}]
    }).then(() => {
  ...
  test("Returns the group- user call", (done) => {
    Group.create({
      name: "test1",
...
test("Admin adds email to group", (done) => {
  Group.create({
    name: "test",
    members: [{email: "test1@email.com"},{email: "test2@email.com"}]
  }).then(() => {
...
test("Admin adds emails to group and a non-existing email", (done) => {
  Group.create({
    name: "test",
    members: [{email: "test1@email.com"},{email: "test2@email.com"}]
  }).then(() => {
...
test("Admin adds emails to group and an email that is already in a group", (done) => {
  Group.create({
    name: "test",
    members: [{email: "test1@email.com"},{email: "test2@email.com"}]
  }).then(() => {
...
test("Admin adds emails to group, a non-existing email and an email that is already in a group", (done) => {
  Group.create({
    name: "test",
    members: [{email: "test1@email.com"},{email: "test2@email.com"}]
  }).then(() => {
...
test("User adds emails to group, a non-existing email and an email that is already in a group", (done) => {
  Group.create({
    name: "test",
    members: [{email: "tester@test.com"},{email: "test2@email.com"}]
  }).then(() => {
...
test("User adds two emails to group, two non-existing emails and two emails that are already in a group", (done) => {
  Group.create({
    name: "test",
    ...
    User.insertMany([
      ...
      .then((response) => {
          ...
          expect(response.body.data.EmailsAlreadyUsed).toHaveLength(2)
          expect(response.body.data.EmailsNotExisting).toHaveLength(2)
          done()
      })
      .catch((err) => done(err))
     })
...
describe("removeFromGroup", () => {
  ...
  test("400 the group doesn't exist",(done) => {
    request(app)
  ...
  test("401 anauthorized - admin route",(done) => {
    request(app)
  ...
  test("401 anauthorized - user route",(done) => {
    request(app)
  ...
  test("400 missing body parameters",(done) => {
    request(app)
        .patch("/api/groups/testgroup/remove")
        .set("Cookie", `accessToken=${testerAccessTokenValid};refreshToken=${testerAccessTokenValid}`)
        .then((response) => {
  ...
  test("400 empty body parameters",(done) => {
    request(app)
        .patch("/api/groups/testgroup/pull")
        .set("Cookie", `accessToken=${adminAccessTokenValid};refreshToken=${adminAccessTokenValid}`)
        .send({emails:[]})
  ...
  test("400 single user group cannot be deleted",(done) => {
    request(app)
  ...
  test("400 invalid mail format",(done) => {
    request(app)
        .patch("/api/groups/testgroup/pull")
        .set("Cookie", `accessToken=${adminAccessTokenValid};refreshToken=${adminAccessTokenValid}`)
  ...
  test("400 none of the emails are in this group",(done) => {
    request(app)
        .patch("/api/groups/testgroup/remove")
        .set("Cookie", `accessToken=${testerAccessTokenValid};refreshToken=${testerAccessTokenValid}`)
  ...
  test("200 succesfull deletion - one mail doesn't exist and one is in another group",(done) => {
    request(app)
        .patch("/api/groups/testgroup/remove")
        .set("Cookie", `accessToken=${testerAccessTokenValid};refreshToken=${testerAccessTokenValid}`)
  ...
  test("200 succesfull deletion - N to remove < N members in group",(done) => {
    request(app)
        .patch("/api/groups/testgroup/remove")
        .set("Cookie", `accessToken=${testerAccessTokenValid};refreshToken=${testerAccessTokenValid}`)
  ...
  test("200 succesfull deletion - multiple users deleted",(done) => {
    request(app)
...
describe("deleteUser", () => {
  ...
  test("should retrieve an error 401 user is not an Amdin", (done) => {
    const reqBody={
  ...
  test("should retrieve an error 400 ,because req attributes missing", (done) => {
    const reqBody={}
    User.create({
      username: "admin1",
  ...
  test("should retrieve an error 400 email empty string", (done) => {
    const reqBody={email: "  "}
    User.create({
      username: "admin1",
      email: "admin1@test.com",
  ...
  test("should retrieve an error 400 incorrect email format", (done) => {
  ...
  test("should retrieve an error 400 email does not exist in database", (done) => {
  ...
  test("Successfull case delete from group and deletetransaction",(done) =>{
  ...
  describe("deleteGroup", () => { 
    ...
    test("The group is deleted", (done) => {
      Group.create({
        name: "test",
        members: [{email: "test1@email.com"},{email: "test2@email.com"}]
      }).then(() => {
